...
const revenueData = [
  ...
  { name: 'Feb', value: 840.20, displayValue: '$840.20' },
  { name: 'Mar', value: 898.00, displayValue: '$898.00' },
  { name: 'Apr', value: 203.00, displayValue: '$203.00' },
  { name: 'May', value: 400.01, displayValue: '$400.01' },
  { name: 'Jun', value: 920.12, displayValue: '$920.12' },
  { name: 'Jul', value: 398.00, displayValue: '$398.00' },
  { name: 'Aug', value: 882.00, displayValue: '$882.00' },
  { name: 'Sep', value: 390.00, displayValue: '$390.00' },
  { name: 'Oct', value: 910.00, displayValue: '$910.00' },
  { name: 'Nov', value: 410.12, displayValue: '$410.12' },
  { name: 'Dec', value: 840.20, displayValue: '$840.20' }
];
    ...
    >
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
        ...
        <Typography variant="subtitle1">
          Total Revenue: <Box component="span" fontWeight="bold" color="#1a237e">${'89,235.89'}</Box>
        </Typography>
      </Box>
